...
objects = ufdt_overlay_test_app.o  util.o LibUfdt/ufdt_convert.o  LibUfdt/ufdt_node.o  LibUfdt/ufdt_node_dict.o  LibUfdt/ufdt_overlay.o  LibUfdt/sysdeps/libufdt_sysdeps_posix.o FdtLib/fdt.o  FdtLib/fdt_empty_tree.o  FdtLib/fdt_ro.o  FdtLib/fdt_rw.o  FdtLib/fdt_strerror.o  FdtLib/fdt_sw.o  FdtLib/fdt_wip.o
